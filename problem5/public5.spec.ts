...
import { Voter } from '../output/solution5_Voter';
...
describe('solution1', () => {
    ...
    it('Excess', async () => {
        ...
        // vote
        const secondVoteResult = await proposal.send(
            voter.getSender(),
            { value: toNano('0.1') },
            {
                $$type: 'Vote',
    ...
    it('Not enough value', async () => {
        ...
        // 1570931n + 3523323n + 2226397n + 1954400n
        const voteResult = await proposal.send(
            voter.getSender(),
            { value: 1570931n + 3523323n + 2226397n + 1954400n },
            {
                $$type: 'Vote',
                value: true,
            },
...
describe('solution3', () => {
    ...
    // it('fees', async () => {
    //     expect(await proposal.getTest()).toEqual(9270951n);
    // });
